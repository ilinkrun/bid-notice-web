...
SETTINGS_NOTICE_LIST_CONFIG_FIELDS = ["url", "iframe", "rowXpath", "paging", "startPage", "endPage", "login", "지역", "등록", "use"]
SETTINGS_NOTICE_LIST_BRIEF_FIELDS = ["기관명", "url", "지역", "등록", "use"]
SETTINGS_NOTICE_LIST_ELEMENT_FIELDS = ["제목", "상세페이지주소", "작성일", "작성자", "제외항목"]
SETTINGS_NOTICE_DETAIL_FIELDS = ["기관명", "제목", "본문", "파일이름", "파일주소", "공고구분", "공고번호", "담당부서", "담당자", "연락처"]
SETTINGS_NOTICE_DETAIL_ELEMENT_FIELDS = ["제목", "본문", "파일이름", "파일주소", "공고구분", "공고번호", "담당부서", "담당자", "연락처"]
SETTINGS_NOTICE_DETAIL_CONFIG_FIELDS = ["제목", "본문", "파일이름", "파일주소", "공고구분", "공고번호", "담당부서", "담당자", "연락처"]
...
SETTINGS_NOTICE_LIST_JSON_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data', 'settings_list.json')
...
## ** SETTINGS(category)
#--------------------------------------------------------------------
def find_all_settings_category(fields=SETTINGS_NOTICE_CATEGORY_FIELDS, addStr="WHERE `use` = 1"):
    """
    모든 키워드 설정을 가져오는 함수
...
## ** SETTINGS(list)
#--------------------------------------------------------------------
def find_settings_list(fields=SETTINGS_NOTICE_LIST_BRIEF_FIELDS, addStr="WHERE `use`=1", out_type="dicts"):
  mysql = Mysql()  # 로컬 MySQL 객체 생성
...
def _find_settings_list_by_name(name, fields=SETTINGS_NOTICE_LIST_CONFIG_FIELDS):
# def _find_settings_list_by_name(name, fields=SETTINGS_NOTICE_LIST_FIELDS):
  """
...
def find_settings_list_by_name(name, fields=SETTINGS_NOTICE_LIST_CONFIG_FIELDS, out_type="tuple"):
# def find_settings_list_by_name(name, fields=SETTINGS_NOTICE_LIST_FIELDS, out_type="tuple"):
  ...
  elements_config = {SETTINGS_NOTICE_LIST_ELEMENT_FIELDS[i]:v for (i, v) in enumerate(_find_settings_list_by_name(name, fields=SETTINGS_NOTICE_LIST_ELEMENT_FIELDS)[0])}
...
## ** SETTINGS(detail)
#--------------------------------------------------------------------
def find_settings_detail(fields=SETTINGS_NOTICE_DETAIL_FIELDS, addStr="WHERE `use`=1", out_type="dicts"):
  mysql = Mysql()  # 로컬 MySQL 객체 생성
...
def _find_settings_detail_by_name(name, fields=SETTINGS_NOTICE_DETAIL_CONFIG_FIELDS, table_name="settings_detail", out_type="tuple"):
# def _find_settings_detail_by_name(name, fields=SETTINGS_NOTICE_DETAIL_FIELDS):
  """
  기관명으로 설정 목록을 검색하는 함수
...
# def find_settings_detail_by_name(name, fields=SETTINGS_NOTICE_DETAIL_FIELDS, out_type="tuple"):
def find_settings_detail_by_name(name, fields=SETTINGS_NOTICE_DETAIL_FIELDS, table_name="settings_detail", out_type="dicts"):
  """
...
def detail_config_by_name(name, fields=SETTINGS_NOTICE_DETAIL_CONFIG_FIELDS, table_name="settings_detail"):
    """
...
def backup_db():
    ...
    try:
        # 백업할 테이블 목록
        tables = ["notices", "settings_list", "settings_detail", "settings_category", "logs_scraping", "errors_notice_scraping"]
