...
/_exp/apps/backends/bid-notice-scraper/app/server_bid.py 서버가 제대로 작동하는지 테스트를 하려고 해요.

root@9a3e98d21219:/_exp/apps/backends/bid-notice-scraper/scripts# ./start_servers.sh
