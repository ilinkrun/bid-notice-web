...
def remove_els_from_html(html_string, xpaths=[]):
    ...
    try:
        ...
        cleaned_html = tostring(tree, encoding='unicode', pretty_print=True, method='html')
        return cleaned_html
...
def download_by_url_with_headers(url, output_dir='downloads', filename=None, headers=None):
    """
