...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='게시판(개발)'
...
CREATE TABLE `board_manual` (
  ...
  KEY `idx_writer` (`writer`),
  KEY `idx_is_visible` (`is_visible`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='게시판(매뉴얼)'
...
CREATE TABLE `board_op` (
  ...
  KEY `idx_writer` (`writer`),
  KEY `idx_is_visible` (`is_visible`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='게시판(운영)'

-- =============================================
-- Table: comments_board
-- Engine: InnoDB
-- Rows: 0
-- Comment: 게시판 댓글
-- =============================================
...
CREATE TABLE `errors_notice_scraping` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8mb4 COMMENT='공고 스크랩 에러'
...
-- Engine: InnoDB
-- Rows: 0
-- Comment: 회사 관련 입찰(공고) 정보
-- =============================================
CREATE TABLE `my_bids` (
...
CREATE TABLE `notice_details` (
  ...
  PRIMARY KEY (`nid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='공고 상세정보'
...
CREATE TABLE `notice_files` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 시간',
  PRIMARY KEY (`nid`,`sn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='공고 첨부 파일'
...
) ENGINE=InnoDB AUTO_INCREMENT=538827 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='공고 목록'

-- =============================================
-- Table: settings_nas_path
-- Engine: InnoDB
-- Rows: 0
-- Comment: 설정(NAS 폴더 경로)
-- =============================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='설정(공고 업무 구분)'

-- =============================================
-- Table: settings_notice_detail
-- Engine: InnoDB
-- Rows: 0
-- Comment: 설정(공고 상세정보 스크랩)
-- =============================================
...
) ENGINE=InnoDB AUTO_INCREMENT=162 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='필드 라벨 매핑 정보'

-- =============================================
-- Table: table_field_label_mappings_0
-- Engine: InnoDB
-- Rows: 161
-- Comment: 필드 라벨 매핑 정보
-- =============================================
CREATE TABLE `table_field_label_mappings_0` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '아이디',
  `table_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '테이블명',
  `field_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '필드키',
  `field_label` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '필드라벨',
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='필드 마이그레이션 정보'

-- =============================================
-- Table: table_migration_fields_0
-- Engine: InnoDB
-- Rows: 42
-- Comment: 필드 마이그레이션 정보
-- =============================================
CREATE TABLE `table_migration_fields_0` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '아이디',
  `table_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '테이블명',
  `field_src` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '원본 필드명',
  `field_dst` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '변경 필드명',
