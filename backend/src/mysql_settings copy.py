...
SETTINGS_NOTICE_LIST_CONFIG_FIELDS = [
    "url", "iframe", "rowXpath", "paging", "startPage", "endPage", "login",
    "org_region", "registration", "use"
]
SETTINGS_NOTICE_LIST_BRIEF_FIELDS = [
    "org_name", "url", "org_region", "registration", "use"
]
SETTINGS_NOTICE_LIST_ELEMENT_FIELDS = [
    "title", "detail_url", "posted_date", "posted_by", "exception_row"
]
SETTINGS_NOTICE_DETAIL_FIELDS = [
    "org_name", "title", "body_html", "file_name", "file_url", "notice_div",
    "notice_num", "org_dept", "org_man", "org_tel"
]
SETTINGS_NOTICE_DETAIL_ELEMENT_FIELDS = [
    "title", "body_html", "file_name", "file_url", "notice_div", "notice_num",
    "org_dept", "org_man", "org_tel"
]
