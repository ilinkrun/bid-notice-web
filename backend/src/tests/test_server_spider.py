...
class TestCheckFetchListEndpoint:
    ...
    def test_check_fetch_list_success(self, mock_scrape_list, successful_scrape_result):
        """정상적인 스크래핑 성공 테스트"""
    ...
    def test_check_fetch_list_failure(self, mock_scrape_list, failed_scrape_result):
        """스크래핑 실패 테스트"""
    ...
    def test_check_fetch_list_exception_handling(self, mock_scrape_list, mock_error_codes):
        """예외 발생 시 처리 테스트"""
    ...
    def test_check_fetch_list_korean_org_name(self, mock_scrape_list, successful_scrape_result):
        ...
        mock_scrape_list.assert_called_once_with(korean_org_name, start_page=1, end_page=2)

    def test_check_fetch_list_special_characters_in_org_name(self, mock_scrape_list):
        """특수문자가 포함된 기관명 테스트"""
...
class TestScrapeListIntegration:
    ...
    def test_scrape_list_parameters(self, mock_scrape_list, successful_scrape_result):
        ...
        mock_scrape_list.assert_called_once_with("파라미터테스트기관", start_page=1, end_page=2)
...
class TestErrorScenarios:
    ...
    def test_unknown_exception_handling(self, mock_scrape_list, mock_error_codes):
        """알 수 없는 예외 처리"""
...
class TestEdgeCases:
    ...
    def test_org_name_with_spaces(self, mock_scrape_list, successful_scrape_result):
        """공백이 포함된 기관명 테스트"""
...
class TestResponseFormat:
    ...
    def test_response_format_consistency(self, mock_scrape_list):
        ...
        for test_case in test_cases:
            ...
            response = client.get(f"/check_fetch_list?org_name={test_case['org_name']}")
