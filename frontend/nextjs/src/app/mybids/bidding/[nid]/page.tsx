...
import BiddingDetailView from '@/components/mybids/BiddingDetailView';
...
export default async function BiddingDetailPage({ params }: { params: Promise<{ nid: string }> }) {
