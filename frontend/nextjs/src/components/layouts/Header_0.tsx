                    ...
                    <div className="w-full py-2">
                        {items.map((item) => (
                            <button
                                ...
                                className={cn(
                                    "flex items-center gap-2 px-6 py-2 transition-colors hover:bg-color-secondary-active/50 w-full text-left",
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "hover:bg-color-secondary-active/50 dark:hover:bg-color-secondary-active/50"
            )}
                ...
                <div className="absolute right-0 top-full mt-2 w-64 p-2 border bg-popover shadow-lg rounded-md">
                    ...
                    <div className="px-3 py-2 border-b mb-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-color-primary-muted-foreground truncate">{user.email}</p>
                                {user.department && (
                                    <p className="text-xs text-color-primary-muted-foreground truncate">{user.department}</p>
                                )}
                    ...
                    <div className="space-y-1">
                        <button
                            ...
                            className="flex items-center gap-2 w-full px-3 py-2 text-sm text-left hover:bg-color-secondary-active rounded-md transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 w-full px-3 py-2 text-sm text-left hover:bg-color-secondary-active rounded-md transition-colors disabled:opacity-50"
                        >
...
export function Header({ isMobileMenuOpen, setIsMobileMenuOpen }: HeaderProps) {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-slate-200 dark:bg-slate-800 backdrop-blur supports-[backdrop-filter]:bg-slate-200/90 supports-[backdrop-filter]:dark:bg-slate-800/90">
                ...
                <div className="flex flex-1 items-center justify-between md:justify-end">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isAuthenticated ? (
                            ...
                            <Link
                                href="/login"
                                className={cn("flex items-center gap-2 text-sm font-medium text-color-primary-muted-foreground transition-colors hover:text-primary", pathname === '/login' && "active")}
                            >
            ...
            {/* 모바일 메뉴 패널 */}
            {isMobileMenuOpen && (
                <div className="fixed inset-0 top-14 z-50 md:hidden border-t">
                            ...
                            {!isAuthenticated && (
                                <div className="py-2">
                                    <Link
                                        ...
                                        className={cn("flex items-center gap-2 px-4 py-2 transition-colors hover:bg-color-secondary-active/50 w-full", pathname === '/login' && "active")}
                                    >
                                        <User className="h-4 w-4" />
                                        <span>로그인</span>
                                    </Link>
